Fazendo uma analogia com o que foi implementado para Produto e Cliente podemos inferir no programa que vai obter um Vendedor de forma aleatória desta maneira:
